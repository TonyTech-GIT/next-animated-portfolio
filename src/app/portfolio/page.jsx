...
const PortfolioPage = () => {
  ...
  console.log("portfolio progress y:", scrollYProgress);
  ...
  return (
    ...
    >
      <div className="h-[600vh] relative" ref={portfolioRef}>
        ...
        <div className="h-screen top-0 sticky flex gap-4 items-center overflow-hidden">
          <motion.div style={{ x }} className="flex">
            ...
            {items.map((item) => (
              <div
                ...
                key={item.id}
              >
                <div className="flex gap-4 flex-col text-white h-[110vh] mt-[5rem]">
                  ...
                  <p className="w-80 md:w-96 lg-[500px] lg:text-lg xl:w-[600px]">
                    {item.desc}
                  </p>
      ...
      <div className="w-screen h-screen flex flex-col gap-16 items-center justify-center text-center mt-[10rem] ">
